...
<html lang="en">
  <head>
    ...
    />
    <title>SKAWAN INDUSTRIES - All Category</title>
    <!-- favicon -->
  ...
  <body class="bg-white text-gray-900">
    ...
    <section class="pt-[80px] sm:pt-[140px] pb-15 px-4">
      <!-- Wrapper -->
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Breadcrumb (kiri atas) -->
        <nav
          class="text-xs sm:text-sm text-gray-500 mt-4 mb-6"
        ...
        >
          <ol class="list-none p-0 inline-flex space-x-1">
            ...
            <li>
              <a class="text-black font-semibold font font-quantify"
                >Category</a
              >
            </li>
          </ol>
      ...
      <!-- Grid Cards -->
      <div
        class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 max-w-7xl mx-auto"
      >
        <!-- Card 1 -->
        <a href="list_product.html">
          <div
            class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer w-full h-[360px] flex flex-col justify-between"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            <!-- Kontainer teks -->
            <div class="p-4 h-[90px] overflow-hidden">
              <h3
                class="text-lg font-semibold text-gray-900 font-quantify truncate"
              >
                category1
              </h3>
              <p class="text-sm text-gray-600 mt-1 font-quantify truncate">
                32 pcs
              </p>
            </div>

            <!-- Kontainer gambar (relatif untuk parallax) -->
            <div
              class="relative h-[270px] w-full overflow-hidden parallax-container"
            >
              <img
                src="image/category1.jpeg"
                alt="LONG T-SHIRT"
                class="parallax-img absolute top-[-10%] left-0 h-[130%] w-full object-cover transition-transform duration-300"
              />
            </div>
          </div>
        </a>
