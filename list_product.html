...
<html lang="en">
  <head>
    ...
    />
    <title>LOW T-SHIRT - Product List</title>
    <!-- favicon -->
  ...
  <body class="bg-white text-gray-900">
    ...
    <!-- Card List Product Section -->
    <section class="pt-[90px] sm:pt-[140px] pb-16 px-4">
      <div class="max-w-7xl mx-auto">
        <!-- Breadcrumb -->
        <nav
          class="text-xs sm:text-sm text-gray-500 mb-4 mt-2 sm:mt-0"
        ...
        >
          <ol class="list-none p-0 inline-flex space-x-1">
            ...
            <li class="text-black font-semibold font-quantify">category1</li>
          </ol>
        </nav>

        <!-- Title -->
        <div class="text-center mb-6" data-aos="fade-up" data-aos-delay="200">
          <h2 class="text-3xl font-bold text-black font-quantify">category1</h2>
          <p class="text-sm text-gray-600 mt-2 font-quantify">
            Pilih Koleksi Kaos untuk Anda Desain.
          </p>
        </div>
        ...
        >
          <div class="relative">
            <input
              type="text"
              placeholder="Cari desain atau nama produk..."
              class="w-full font-quantify border border-gray-300 rounded-full py-3 pl-5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-black"
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 text-gray-500 absolute right-4 top-1/2 transform -translate-y-1/2"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        <!-- Grid Cards Products -->
        <div
          class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6"
        >
          <!-- Card 1 -->
          <a href="detail_product.html">
            ...
            >
              ...
              />
              <div
                class="p-4 text-center min-h-[100px] flex flex-col justify-center"
              >
                <h3
                  class="text-base sm:text-lg font-semibold text-black font-quantify truncate"
                >
                  Product 1
                </h3>
                <p class="text-xs sm:text-sm text-gray-600 mt-1 font-quantify">
                  Rp 129.000
                </p>
              </div>
            </div>
