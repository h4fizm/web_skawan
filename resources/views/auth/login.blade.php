...
@section('content')
    ...
    <div class="col-lg-5 col-12 d-flex flex-column">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="/"><img src="{{ asset('image/icon.JPG') }}" alt="Logo"></a>
            </div>
    ...
    <div class="col-lg-7 d-none d-lg-block">
        <div id="auth-right" style="background-image: url({{ asset('/images/bg-auth.png') }}); background-size: cover; height: 100vh; 
            width: 100%;">
        </div>
    </div>
@endsection
        ...
        $(document).ready(function() {
            $('#form_send_reset_link').on('submit', function(e) {
                ...
                var arr_params = {
                    ...
                    modal: modalId,
                    reload: false,
                    load_msg: 'Sedang Mengirim username...'
                }
