...
<html lang="en">
  ...
  <body class="bg-white text-white">
    ...
    >
      ...
      <div class="flex-1 relative overflow-visible z-0">
        <!-- Gambar Produk -->
        <div
          class="w-full border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center bg-white px-6 py-6"
        >
          <img
      ...
      <!-- === KANAN: Informasi Produk (Desain Bar) === -->
      <div
        class="w-full lg:w-80 flex-none bg-white border border-[#d1a86f] p-4 rounded-2xl shadow-xl mt-2 lg:mt-0 max-h-[680px] overflow-y-auto"
      >
        <!-- Judul -->
        <h2
        ...
        <div class="mt-10 text-center">
          <button
            class="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#d1a86f] text-[#0f2d25] font-medium hover:bg-[#c1985e] transition text-[15px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
