...
<html lang="en">
  ...
  <body class="bg-white text-gray-900">
    ...
    <!-- Profile Card (styled sama dengan card bawah) -->
    <div class="max-w-7xl mx-auto px-4 pt-6 sm:pt-[100px] sm:pt-10">
      <!-- Title -->
      <div
        class="text-center mb-6 mt-16 md:mt-6"
        data-aos="fade-up"
        data-aos-delay="200"
      >
      ...
      >
        <!-- LEFT: Profile Info -->
        <div
          class="flex flex-col items-center justify-center space-y-4 py-6 min-h-[300px]"
        >
          ...
          <label for="photo" class="relative cursor-pointer group">
            <img
              ...
              alt="Foto Profil"
              class="w-48 h-48 rounded-full border-4 border-black object-cover shadow transition group-hover:brightness-75"
            />
            <!-- Overlay teks edit -->
            <div
              class="font-quantify absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white text-sm font-medium opacity-0 group-hover:opacity-100 transition rounded-full"
            >
              Ganti Foto
            </div>
          </label>
          ...
          <div class="text-center">
            <h2 class="text-2xl font-semibold text-gray-800 font-quantify">
              Muchlis
            </h2>
            <p class="text-base text-gray-500 font-quantify">user@email.com</p>
          </div>
        </div>
        ...
        <form class="space-y-4 w-full">
          ...
          >
            <a
              ...
              class="font-quantify inline-block text-center px-6 py-2 border border-gray-800 text-gray-800 rounded-md hover:bg-gray-100 transition font-medium w-full sm:w-fit"
            >
              Kembali
            </a>
            <button
              type="submit"
              class="font-quantify bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md font-medium transition w-full sm:w-fit"
            >
              Simpan Perubahan
            </button>
          </div>
