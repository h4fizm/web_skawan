  ...
  <body class="bg-white text-white">
    ...
    >
      ...
      >
        ...
        <a
          href="#"
          class="flex items-center justify-center gap-2 text-xs sm:text-sm font-quantify px-3 py-1.5 sm:px-4 sm:py-2 border border-[#0f2d25] text-white bg-[#0f2d25] rounded-full hover:bg-[#143c31] transition"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4 sm:h-5 sm:w-5"
    ...
    <div
      class="relative overflow-visible z-0 flex flex-col-reverse lg:flex-row gap-x-6 mt-[160px] px-4 mb-5 h-auto"
    >
      <!-- === KIRI: Desain Bar === -->
      <div
      ...
      >
        ...
        <div class="mb-4">
          ...
          <label class="flex items-center gap-3 cursor-pointer group">
            ...
            <!-- Kotak warna -->
            <div
              class="w-9 h-9 rounded-lg bg-[#a92b2b] border border-gray-300 group-hover:scale-105 transition transform peer-checked:ring-2 peer-checked:ring-[#a92b2b] peer-checked:ring-offset-2 peer-checked:ring-offset-white shadow-md"
            ></div>
            <!-- Label keterangan -->
            <span class="text-sm text-[#0f2d25] font-medium"
              >Warna Pilihan</span
            >
          </label>
        </div>
        ...
        <!-- Fitur Teks -->
        <div
          class="mb-4 border border-gray-300 p-3 rounded text-xs text-[#0f2d25] bg-gray-50 h-[260px]"
        >
          <p class="font-bold mb-1">Fitur Buat Teks:</p>
          <ul class="list-disc list-inside leading-snug">
            <li>Pilih font</li>
            <li>Ukuran font</li>
            <li>Warna</li>
            <li>Text curve</li>
          ...
          <p class="mt-2">
            Bagian ini muncul ketika button buat teks ditekan dan bisa
            dihilangkan dengan tombol close di pojok kanan bagian ini.
          </p>
        </div>
        ...
        <div class="mt-4">
          <label class="block text-xs text-[#0f2d25] mb-2 font-quantify">
            Letakkan Gambar atau Icon pada Desainmu
          </label>
          <label
            for="upload-photo"
            class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-[#0f2d25] rounded cursor-pointer bg-white hover:bg-gray-50 transition h-[200px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- === TENGAH: 3 Icon Button === -->
      <div
        class="flex w-full lg:w-auto flex-row lg:flex-col gap-4 items-center justify-center mt-8 lg:mt-4 mb-6 relative"
      >
        <!-- Icon 1 - Panduan Spot Logo (TANDA TANYA) -->
        <div class="group relative">
          <button
            class="w-12 h-12 rounded-lg bg-[#d1a86f] text-[#0f2d25] flex items-center justify-center shadow hover:bg-[#c1985e] transition"
          >
            <!-- Icon: Tanda Tanya -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            class="absolute sm:left-14 sm:top-1/2 sm:-translate-y-1/2 sm:translate-x-0 left-1/2 top-full mt-2 -translate-x-1/2 bg-[#0f2d25] text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap z-50"
          >
            Panduan Spot Logo
          </span>
        </div>

        <!-- Icon 2 - Deskripsi Produk (Dokumen) -->
        <div class="group relative">
          <button
        ...
        <div
          ...
          class="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center px-4 hidden"
        >
          <div
          ...
          >
            ...
            <p class="text-sm text-gray-700 leading-relaxed">
              Produk ini merupakan kaos berkualitas tinggi yang terbuat dari
              bahan katun premium, nyaman dipakai sepanjang hari. Desain
              minimalis namun elegan membuatnya cocok digunakan dalam berbagai
              suasana baik formal maupun santai.
            </p>
          </div>
        </div>

        <!-- Icon 3 - Size Chart (Bar Chart) -->
        <div class="group relative">
          <button
      ...
      <!-- Wrapper Gambar + Panel -->
      <div class="flex-1 relative h-[700px] overflow-visible z-0">
        <!-- Gambar Produk -->
        <div
          class="w-full h-full border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center bg-white px-6 py-6"
        >
          <img
    ...
    <div class="sm:hidden mt-4 px-4 w-full">
      <div class="flex flex-col gap-3 w-full max-w-xs mx-auto">
        ...
        <a
          href="#"
          class="w-full flex items-center justify-center gap-2 text-sm font-quantify px-4 py-3 border border-[#0f2d25] text-white bg-[#0f2d25] rounded-xl hover:bg-[#143c31] transition"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
